    ...
    <div>
      ...
      <div className="flex-1 space-y-4 max-w-[800px] mx-auto px-8 sm:px-6 lg:px-8">
        ...
        <BlurFade delay={BLUR_FADE_DELAY * 8} inView>
          <h1 className="text-lg font-bold text-gray-500 dark:text-white">
          I&apos;ve been programming since I was 13, and I&apos;ve worked on diverse projects: using AI and satellite imagery to detect invasive vegetation for an agtech company, building websites for a wedding planning agency, and creating APIs to automate internal processes—including integration with Apple&apos;s internal platforms. {/*I&apos;ve also contributed to telecommunication projects with major industry players like Spark and Vodafone*/} [REDACTED], honing my problem-solving skills and adaptability along the way.
          </h1>
        </BlurFade>
