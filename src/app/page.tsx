...
const jobs = [
  ...
  },
  {
    ...
    description:
      "I've had the privilege of working with CreaturePost, starting with the LUMA Light Show in 2023 and 2024. During that time, we launched Imaginaium—an innovative video feed that uses AI-generated imagery, dynamically evolving based on live microphone input and several other projects including one of Skinny Mobiles ad campign with their new AI ambassador, Liz. Initially a prototype with limited performance, we leveraged advancing technology to transform it into the captivating visual installation we envisioned.", // In July 2024, we embarked on an exciting project for a prominent New Zealand telco company. While details are still under wraps, the progress we've made is incredibly promising.Working with CreaturePost has been a rewarding experience, full of creativity, collaboration, and meaningful strides in visual and AI-driven innovation.",
    logoUrl:
    ...
    <div>
      ...
      <div className="flex-1 space-y-4 max-w-[800px] mx-auto px-8 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-3">
          {jobs.map((job, index) => (
            <BlurFade key={index} inView delay={BLUR_FADE_DELAY * (index + 8)}>
              <ResumeCard
                key={index}
                logoUrl={job.logoUrl}
                altText={job.altText}
